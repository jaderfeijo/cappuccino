...
- (void)testStringByAddingPercentEscapes
{
    var decodedString = "http://w3schools.com/my test.asp?name=ståle&car=saab";   
    [self assert:"http%3A%2F%2Fw3schools.com%2Fmy%20test.asp%3Fname%3Dst%C3%A5le%26car%3Dsaab" equals:[decodedString stringByAddingPercentEscapes]];
}

- (void)testStringByReplacingPercentEscapes
{
    var encodedString = "http%3A%2F%2Fw3schools.com%2Fmy%20test.asp%3Fname%3Dst%C3%A5le%26car%3Dsaab";
    [self assert:"http://w3schools.com/my test.asp?name=ståle&car=saab" equals:[encodedString stringByReplacingPercentEscapes]];
}
